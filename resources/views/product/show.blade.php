<x-layout>
    <x-logo/>
    <div x-data="{isVisible : true}" class="flex justify-center items-center bg-black h-screen text-white">
        ...
        <div class="bg-gray h-5/6 w-5/6 flex p-5 border border-gold space-x-4">
            <div class="flex border border-gold w-1/2 items-center justify-center aspect-square">
                <img src="{{ asset("/storage/" . $product->image) }}" class="object-cover h-full object-center">
            </div>
            <div class="flex flex-col my-10 lg 2xl:space-y-28 xl:space-y-16 w-1/2">
