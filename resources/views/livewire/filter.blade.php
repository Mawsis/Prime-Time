        ...
        <div class="h-10 space-x-8 bg-black text-white flex justify-center items-center">
            ...
            <div class="flex space-x-4 items-center">
                ...
                <div class="flex justify-center items-center space-x-1">
                    ...
                    wire:model.live="priceMin"  name="priceMin" min="1" max="15000">
                    <div>{{ $priceMin }}</div>
                </div>                
                <div class="flex justify-center items-center space-x-1">
                    ...
                    wire:model.live="priceMax"  name="priceMax" min="1" max="15000">
                    <div>{{ $priceMax }}</div>
                </div>                

                <input type="text" placeholder="Search" wire:model.live='search' class="text-black p-1">
            </div>
        </div>
